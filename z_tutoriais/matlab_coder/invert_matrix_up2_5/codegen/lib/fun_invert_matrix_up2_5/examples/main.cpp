...
static void main_fun_invert_matrix_up2_5();
...
static void main_fun_invert_matrix_up2_5()
{
  ...
  int A_size[2];
  int Ai_size[2];
  // Initialize function 'fun_invert_matrix_up2_5' input arguments.
  // Initialize function input argument 'A'.
  argInit_d5xd5_real_T(A_data, A_size);
  // Call the entry-point 'fun_invert_matrix_up2_5'.
