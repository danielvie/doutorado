...
{\Huge \bf A flying capacitor three-cell converter controlled by Python} 
...
\textit{Write a short description of the hardware and provide context, i.e., describe similar open hardware and proprietary equipment in the field. \textcolor{red}{Algo que tenha sido usado nos artigos da literatura.}}
...
\begin{itemize}
\item Diagrama do circuito com chaves conceituais.
\item Esquemático ?
\item PCB layout e figura 3d. 
\item Foto da placa.
...
\dots & IRF 740 n-channel mosfet & 8 & \dots & \dots & \dots & \dots \\\hline
...
\dots & INA-132 instrumentation amplifier & 2 & \dots & \dots & \dots & \dots \\\hline
