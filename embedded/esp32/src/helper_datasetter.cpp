...
void helper_set_dataset_from_alpha(DataSet *dataset, const float alpha) {
    ...
    if (helper_eql_float(alpha, 0.11)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 31;
        dataset->time_vec[1] = 63;
        dataset->time_vec[2] = 31;
        dataset->time_vec[3] = 63;
        dataset->time_vec[4] = 31;
        dataset->time_vec[5] = 63;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 0;
    ...
    if (helper_eql_float(alpha, 0.12)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 34;
        dataset->time_vec[1] = 60;
        dataset->time_vec[2] = 34;
        dataset->time_vec[3] = 60;
        dataset->time_vec[4] = 34;
        dataset->time_vec[5] = 60;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 0;
    ...
    if (helper_eql_float(alpha, 0.13)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 36;
        dataset->time_vec[1] = 57;
        dataset->time_vec[2] = 36;
        dataset->time_vec[3] = 57;
        dataset->time_vec[4] = 36;
        dataset->time_vec[5] = 57;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 0;
    ...
    if (helper_eql_float(alpha, 0.14)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 39;
        dataset->time_vec[1] = 54;
        dataset->time_vec[2] = 39;
        dataset->time_vec[3] = 54;
        dataset->time_vec[4] = 39;
        dataset->time_vec[5] = 54;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 0;
    ...
    if (helper_eql_float(alpha, 0.15)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 42;
        dataset->time_vec[1] = 51;
        dataset->time_vec[2] = 42;
        dataset->time_vec[3] = 51;
        dataset->time_vec[4] = 42;
        dataset->time_vec[5] = 51;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 0;
    ...
    if (helper_eql_float(alpha, 0.16)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 45;
        dataset->time_vec[1] = 49;
        dataset->time_vec[2] = 45;
        dataset->time_vec[3] = 49;
        dataset->time_vec[4] = 45;
        dataset->time_vec[5] = 49;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 0;
    ...
    if (helper_eql_float(alpha, 0.17)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 48;
        dataset->time_vec[1] = 46;
        dataset->time_vec[2] = 48;
        dataset->time_vec[3] = 46;
        dataset->time_vec[4] = 48;
        dataset->time_vec[5] = 46;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 0;
    ...
    if (helper_eql_float(alpha, 0.18)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 50;
        dataset->time_vec[1] = 43;
        dataset->time_vec[2] = 50;
        dataset->time_vec[3] = 43;
        dataset->time_vec[4] = 50;
        dataset->time_vec[5] = 43;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 0;
    ...
    if (helper_eql_float(alpha, 0.19)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 53;
        dataset->time_vec[1] = 40;
        dataset->time_vec[2] = 53;
        dataset->time_vec[3] = 40;
        dataset->time_vec[4] = 53;
        dataset->time_vec[5] = 40;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 0;
    ...
    if (helper_eql_float(alpha, 0.21)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 59;
        dataset->time_vec[1] = 35;
        dataset->time_vec[2] = 59;
        dataset->time_vec[3] = 35;
        dataset->time_vec[4] = 59;
        dataset->time_vec[5] = 35;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 0;
    ...
    if (helper_eql_float(alpha, 0.22)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 62;
        dataset->time_vec[1] = 32;
        dataset->time_vec[2] = 62;
        dataset->time_vec[3] = 32;
        dataset->time_vec[4] = 62;
        dataset->time_vec[5] = 32;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 0;
    ...
    if (helper_eql_float(alpha, 0.23)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 64;
        dataset->time_vec[1] = 29;
        dataset->time_vec[2] = 64;
        dataset->time_vec[3] = 29;
        dataset->time_vec[4] = 64;
        dataset->time_vec[5] = 29;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 0;
    ...
    if (helper_eql_float(alpha, 0.24)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 67;
        dataset->time_vec[1] = 26;
        dataset->time_vec[2] = 67;
        dataset->time_vec[3] = 26;
        dataset->time_vec[4] = 67;
        dataset->time_vec[5] = 26;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 0;
    ...
    if (helper_eql_float(alpha, 0.25)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 70;
        dataset->time_vec[1] = 23;
        dataset->time_vec[2] = 70;
        dataset->time_vec[3] = 23;
        dataset->time_vec[4] = 70;
        dataset->time_vec[5] = 23;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 0;
    ...
    if (helper_eql_float(alpha, 0.26)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 73;
        dataset->time_vec[1] = 21;
        dataset->time_vec[2] = 73;
        dataset->time_vec[3] = 21;
        dataset->time_vec[4] = 73;
        dataset->time_vec[5] = 21;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 0;
    ...
    if (helper_eql_float(alpha, 0.27)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 76;
        dataset->time_vec[1] = 18;
        dataset->time_vec[2] = 76;
        dataset->time_vec[3] = 18;
        dataset->time_vec[4] = 76;
        dataset->time_vec[5] = 18;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 0;
    ...
    if (helper_eql_float(alpha, 0.28)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 78;
        dataset->time_vec[1] = 15;
        dataset->time_vec[2] = 78;
        dataset->time_vec[3] = 15;
        dataset->time_vec[4] = 78;
        dataset->time_vec[5] = 15;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 0;
    ...
    if (helper_eql_float(alpha, 0.29)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 81;
        dataset->time_vec[1] = 12;
        dataset->time_vec[2] = 81;
        dataset->time_vec[3] = 12;
        dataset->time_vec[4] = 81;
        dataset->time_vec[5] = 12;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 0;
    ...
    if (helper_eql_float(alpha, 0.31)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 87;
        dataset->time_vec[1] = 7;
        dataset->time_vec[2] = 87;
        dataset->time_vec[3] = 7;
        dataset->time_vec[4] = 87;
        dataset->time_vec[5] = 7;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 0;
    ...
    if (helper_eql_float(alpha, 0.32)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 90;
        dataset->time_vec[1] = 7;
        dataset->time_vec[2] = 90;
        dataset->time_vec[3] = 7;
        dataset->time_vec[4] = 90;
        dataset->time_vec[5] = 7;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
    ...
    if (helper_eql_float(alpha, 0.33)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 92;
        dataset->time_vec[1] = 7;
        dataset->time_vec[2] = 92;
        dataset->time_vec[3] = 7;
        dataset->time_vec[4] = 92;
        dataset->time_vec[5] = 7;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
    ...
    if (helper_eql_float(alpha, 0.34)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 91;
        dataset->time_vec[1] = 7;
        dataset->time_vec[2] = 91;
        dataset->time_vec[3] = 7;
        dataset->time_vec[4] = 91;
        dataset->time_vec[5] = 7;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
    ...
    if (helper_eql_float(alpha, 0.35)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 89;
        dataset->time_vec[1] = 7;
        dataset->time_vec[2] = 89;
        dataset->time_vec[3] = 7;
        dataset->time_vec[4] = 89;
        dataset->time_vec[5] = 7;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
    ...
    if (helper_eql_float(alpha, 0.36)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 86;
        dataset->time_vec[1] = 7;
        dataset->time_vec[2] = 86;
        dataset->time_vec[3] = 7;
        dataset->time_vec[4] = 86;
        dataset->time_vec[5] = 7;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
    ...
    if (helper_eql_float(alpha, 0.37)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 83;
        dataset->time_vec[1] = 10;
        dataset->time_vec[2] = 83;
        dataset->time_vec[3] = 10;
        dataset->time_vec[4] = 83;
        dataset->time_vec[5] = 10;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.38)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 80;
        dataset->time_vec[1] = 13;
        dataset->time_vec[2] = 80;
        dataset->time_vec[3] = 13;
        dataset->time_vec[4] = 80;
        dataset->time_vec[5] = 13;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.39)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 77;
        dataset->time_vec[1] = 16;
        dataset->time_vec[2] = 77;
        dataset->time_vec[3] = 16;
        dataset->time_vec[4] = 77;
        dataset->time_vec[5] = 16;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.41)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 72;
        dataset->time_vec[1] = 21;
        dataset->time_vec[2] = 72;
        dataset->time_vec[3] = 21;
        dataset->time_vec[4] = 72;
        dataset->time_vec[5] = 21;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
    ...
    if (helper_eql_float(alpha, 0.42)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 69;
        dataset->time_vec[1] = 24;
        dataset->time_vec[2] = 69;
        dataset->time_vec[3] = 24;
        dataset->time_vec[4] = 69;
        dataset->time_vec[5] = 24;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.43)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 66;
        dataset->time_vec[1] = 27;
        dataset->time_vec[2] = 66;
        dataset->time_vec[3] = 27;
        dataset->time_vec[4] = 66;
        dataset->time_vec[5] = 27;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.44)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 63;
        dataset->time_vec[1] = 30;
        dataset->time_vec[2] = 63;
        dataset->time_vec[3] = 30;
        dataset->time_vec[4] = 63;
        dataset->time_vec[5] = 30;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.45)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 61;
        dataset->time_vec[1] = 33;
        dataset->time_vec[2] = 61;
        dataset->time_vec[3] = 33;
        dataset->time_vec[4] = 61;
        dataset->time_vec[5] = 33;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.46)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 58;
        dataset->time_vec[1] = 35;
        dataset->time_vec[2] = 58;
        dataset->time_vec[3] = 35;
        dataset->time_vec[4] = 58;
        dataset->time_vec[5] = 35;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
    ...
    if (helper_eql_float(alpha, 0.47)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 55;
        dataset->time_vec[1] = 38;
        dataset->time_vec[2] = 55;
        dataset->time_vec[3] = 38;
        dataset->time_vec[4] = 55;
        dataset->time_vec[5] = 38;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.48)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 52;
        dataset->time_vec[1] = 41;
        dataset->time_vec[2] = 52;
        dataset->time_vec[3] = 41;
        dataset->time_vec[4] = 52;
        dataset->time_vec[5] = 41;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.49)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 49;
        dataset->time_vec[1] = 44;
        dataset->time_vec[2] = 49;
        dataset->time_vec[3] = 44;
        dataset->time_vec[4] = 49;
        dataset->time_vec[5] = 44;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.51)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 44;
        dataset->time_vec[1] = 49;
        dataset->time_vec[2] = 44;
        dataset->time_vec[3] = 49;
        dataset->time_vec[4] = 44;
        dataset->time_vec[5] = 49;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
    ...
    if (helper_eql_float(alpha, 0.52)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 41;
        dataset->time_vec[1] = 52;
        dataset->time_vec[2] = 41;
        dataset->time_vec[3] = 52;
        dataset->time_vec[4] = 41;
        dataset->time_vec[5] = 52;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.53)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 38;
        dataset->time_vec[1] = 55;
        dataset->time_vec[2] = 38;
        dataset->time_vec[3] = 55;
        dataset->time_vec[4] = 38;
        dataset->time_vec[5] = 55;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.54)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 35;
        dataset->time_vec[1] = 58;
        dataset->time_vec[2] = 35;
        dataset->time_vec[3] = 58;
        dataset->time_vec[4] = 35;
        dataset->time_vec[5] = 58;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.55)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 33;
        dataset->time_vec[1] = 61;
        dataset->time_vec[2] = 33;
        dataset->time_vec[3] = 61;
        dataset->time_vec[4] = 33;
        dataset->time_vec[5] = 61;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.56)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 30;
        dataset->time_vec[1] = 63;
        dataset->time_vec[2] = 30;
        dataset->time_vec[3] = 63;
        dataset->time_vec[4] = 30;
        dataset->time_vec[5] = 63;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
    ...
    if (helper_eql_float(alpha, 0.57)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 27;
        dataset->time_vec[1] = 66;
        dataset->time_vec[2] = 27;
        dataset->time_vec[3] = 66;
        dataset->time_vec[4] = 27;
        dataset->time_vec[5] = 66;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.58)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 24;
        dataset->time_vec[1] = 69;
        dataset->time_vec[2] = 24;
        dataset->time_vec[3] = 69;
        dataset->time_vec[4] = 24;
        dataset->time_vec[5] = 69;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.59)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 21;
        dataset->time_vec[1] = 72;
        dataset->time_vec[2] = 21;
        dataset->time_vec[3] = 72;
        dataset->time_vec[4] = 21;
        dataset->time_vec[5] = 72;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.61)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 16;
        dataset->time_vec[1] = 77;
        dataset->time_vec[2] = 16;
        dataset->time_vec[3] = 77;
        dataset->time_vec[4] = 16;
        dataset->time_vec[5] = 77;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.62)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 13;
        dataset->time_vec[1] = 80;
        dataset->time_vec[2] = 13;
        dataset->time_vec[3] = 80;
        dataset->time_vec[4] = 13;
        dataset->time_vec[5] = 80;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.63)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 10;
        dataset->time_vec[1] = 83;
        dataset->time_vec[2] = 10;
        dataset->time_vec[3] = 83;
        dataset->time_vec[4] = 10;
        dataset->time_vec[5] = 83;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.64)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 7;
        dataset->time_vec[1] = 86;
        dataset->time_vec[2] = 7;
        dataset->time_vec[3] = 86;
        dataset->time_vec[4] = 7;
        dataset->time_vec[5] = 86;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.65)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 7;
        dataset->time_vec[1] = 89;
        dataset->time_vec[2] = 7;
        dataset->time_vec[3] = 89;
        dataset->time_vec[4] = 7;
        dataset->time_vec[5] = 89;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.66)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 7;
        dataset->time_vec[1] = 91;
        dataset->time_vec[2] = 7;
        dataset->time_vec[3] = 91;
        dataset->time_vec[4] = 7;
        dataset->time_vec[5] = 91;
        dataset->d4_vec[0] = 0;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 0;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.67)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 7;
        dataset->time_vec[1] = 92;
        dataset->time_vec[2] = 7;
        dataset->time_vec[3] = 92;
        dataset->time_vec[4] = 7;
        dataset->time_vec[5] = 92;
        dataset->d4_vec[0] = 1;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 1;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.68)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 7;
        dataset->time_vec[1] = 90;
        dataset->time_vec[2] = 7;
        dataset->time_vec[3] = 90;
        dataset->time_vec[4] = 7;
        dataset->time_vec[5] = 90;
        dataset->d4_vec[0] = 1;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 1;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.69)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 7;
        dataset->time_vec[1] = 87;
        dataset->time_vec[2] = 7;
        dataset->time_vec[3] = 87;
        dataset->time_vec[4] = 7;
        dataset->time_vec[5] = 87;
        dataset->d4_vec[0] = 1;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 1;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.71)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 12;
        dataset->time_vec[1] = 81;
        dataset->time_vec[2] = 12;
        dataset->time_vec[3] = 81;
        dataset->time_vec[4] = 12;
        dataset->time_vec[5] = 81;
        dataset->d4_vec[0] = 1;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 1;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.72)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 15;
        dataset->time_vec[1] = 78;
        dataset->time_vec[2] = 15;
        dataset->time_vec[3] = 78;
        dataset->time_vec[4] = 15;
        dataset->time_vec[5] = 78;
        dataset->d4_vec[0] = 1;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 1;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.73)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 18;
        dataset->time_vec[1] = 76;
        dataset->time_vec[2] = 18;
        dataset->time_vec[3] = 76;
        dataset->time_vec[4] = 18;
        dataset->time_vec[5] = 76;
        dataset->d4_vec[0] = 1;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 1;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.74)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 21;
        dataset->time_vec[1] = 73;
        dataset->time_vec[2] = 21;
        dataset->time_vec[3] = 73;
        dataset->time_vec[4] = 21;
        dataset->time_vec[5] = 73;
        dataset->d4_vec[0] = 1;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 1;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.75)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 23;
        dataset->time_vec[1] = 70;
        dataset->time_vec[2] = 23;
        dataset->time_vec[3] = 70;
        dataset->time_vec[4] = 23;
        dataset->time_vec[5] = 70;
        dataset->d4_vec[0] = 1;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 1;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.76)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 26;
        dataset->time_vec[1] = 67;
        dataset->time_vec[2] = 26;
        dataset->time_vec[3] = 67;
        dataset->time_vec[4] = 26;
        dataset->time_vec[5] = 67;
        dataset->d4_vec[0] = 1;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 1;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.77)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 29;
        dataset->time_vec[1] = 64;
        dataset->time_vec[2] = 29;
        dataset->time_vec[3] = 64;
        dataset->time_vec[4] = 29;
        dataset->time_vec[5] = 64;
        dataset->d4_vec[0] = 1;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 1;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.78)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 32;
        dataset->time_vec[1] = 62;
        dataset->time_vec[2] = 32;
        dataset->time_vec[3] = 62;
        dataset->time_vec[4] = 32;
        dataset->time_vec[5] = 62;
        dataset->d4_vec[0] = 1;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 1;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.79)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 35;
        dataset->time_vec[1] = 59;
        dataset->time_vec[2] = 35;
        dataset->time_vec[3] = 59;
        dataset->time_vec[4] = 35;
        dataset->time_vec[5] = 59;
        dataset->d4_vec[0] = 1;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 1;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.81)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 40;
        dataset->time_vec[1] = 53;
        dataset->time_vec[2] = 40;
        dataset->time_vec[3] = 53;
        dataset->time_vec[4] = 40;
        dataset->time_vec[5] = 53;
        dataset->d4_vec[0] = 1;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 1;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.82)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 43;
        dataset->time_vec[1] = 50;
        dataset->time_vec[2] = 43;
        dataset->time_vec[3] = 50;
        dataset->time_vec[4] = 43;
        dataset->time_vec[5] = 50;
        dataset->d4_vec[0] = 1;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 1;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.83)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 46;
        dataset->time_vec[1] = 48;
        dataset->time_vec[2] = 46;
        dataset->time_vec[3] = 48;
        dataset->time_vec[4] = 46;
        dataset->time_vec[5] = 48;
        dataset->d4_vec[0] = 1;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 1;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.84)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 49;
        dataset->time_vec[1] = 45;
        dataset->time_vec[2] = 49;
        dataset->time_vec[3] = 45;
        dataset->time_vec[4] = 49;
        dataset->time_vec[5] = 45;
        dataset->d4_vec[0] = 1;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 1;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.85)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 51;
        dataset->time_vec[1] = 42;
        dataset->time_vec[2] = 51;
        dataset->time_vec[3] = 42;
        dataset->time_vec[4] = 51;
        dataset->time_vec[5] = 42;
        dataset->d4_vec[0] = 1;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 1;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.86)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 54;
        dataset->time_vec[1] = 39;
        dataset->time_vec[2] = 54;
        dataset->time_vec[3] = 39;
        dataset->time_vec[4] = 54;
        dataset->time_vec[5] = 39;
        dataset->d4_vec[0] = 1;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 1;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.87)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 57;
        dataset->time_vec[1] = 36;
        dataset->time_vec[2] = 57;
        dataset->time_vec[3] = 36;
        dataset->time_vec[4] = 57;
        dataset->time_vec[5] = 36;
        dataset->d4_vec[0] = 1;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 1;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.88)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 60;
        dataset->time_vec[1] = 34;
        dataset->time_vec[2] = 60;
        dataset->time_vec[3] = 34;
        dataset->time_vec[4] = 60;
        dataset->time_vec[5] = 34;
        dataset->d4_vec[0] = 1;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 1;
        dataset->d4_vec[3] = 1;
    ...
    if (helper_eql_float(alpha, 0.89)) {
        ...
        dataset->size_vec = 6;
        dataset->time_vec[0] = 63;
        dataset->time_vec[1] = 31;
        dataset->time_vec[2] = 63;
        dataset->time_vec[3] = 31;
        dataset->time_vec[4] = 63;
        dataset->time_vec[5] = 31;
        dataset->d4_vec[0] = 1;
        dataset->d4_vec[1] = 0;
        dataset->d4_vec[2] = 1;
        dataset->d4_vec[3] = 1;
