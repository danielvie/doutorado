...
void helper_set_dataset_from_alpha(DataSet *dataset, const float alpha) {
    ...
    if (helper_eql_float(alpha, 0.34)) {
        ...
        dataset->modes_d4[1] = 0;
        dataset->modes_d4[2] = 0;
        dataset->modes_d4[3] = MASK_OUT_4;
        dataset->modes_d4[4] = MASK_OUT_4;
        dataset->modes_d4[5] = MASK_OUT_4;
        dataset->modes_d5[0] = 0;
        dataset->modes_d5[1] = MASK_OUT_5;
        dataset->modes_d5[2] = MASK_OUT_5;
        dataset->modes_d5[3] = MASK_OUT_5;
        dataset->modes_d5[4] = 0;
        dataset->modes_d5[5] = 0;
        dataset->modes_d6[0] = MASK_OUT_6;
        dataset->modes_d6[1] = MASK_OUT_6;
        dataset->modes_d6[2] = 0;
        dataset->modes_d6[3] = 0;
        dataset->modes_d6[4] = 0;
        dataset->modes_d6[5] = MASK_OUT_6;
    ...
    if (helper_eql_float(alpha, 0.67)) {
        ...
        dataset->modes_d4[0] = MASK_OUT_4;
        dataset->modes_d4[1] = 0;
        dataset->modes_d4[2] = MASK_OUT_4;
        dataset->modes_d4[3] = MASK_OUT_4;
        dataset->modes_d4[4] = MASK_OUT_4;
        dataset->modes_d4[5] = MASK_OUT_4;
        dataset->modes_d5[0] = MASK_OUT_5;
        dataset->modes_d5[1] = MASK_OUT_5;
        dataset->modes_d5[2] = MASK_OUT_5;
        dataset->modes_d5[3] = MASK_OUT_5;
        dataset->modes_d5[4] = MASK_OUT_5;
        dataset->modes_d5[5] = 0;
        dataset->modes_d6[0] = MASK_OUT_6;
        dataset->modes_d6[1] = MASK_OUT_6;
        dataset->modes_d6[2] = MASK_OUT_6;
        dataset->modes_d6[3] = 0;
        dataset->modes_d6[4] = MASK_OUT_6;
        dataset->modes_d6[5] = MASK_OUT_6;
