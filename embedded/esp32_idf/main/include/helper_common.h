...
#define DEFAULT_SIGNAL_EDGE_OVERHEAD_UP_CYCLES 0
#define DEFAULT_SIGNAL_EDGE_OVERHEAD_DOWN_CYCLES 35
...
extern volatile uint32_t g_dead_time_up_tenths_us;
extern volatile uint32_t g_dead_time_down_tenths_us;
