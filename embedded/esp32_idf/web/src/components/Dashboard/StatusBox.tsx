...
export default function StatusBox() {
    ...
    return (
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-xs font-mono text-blue-800 break-words mb-4 overflow-hidden relative group">
            ...
            {isVisible && (
                <div className="whitespace-pre-wrap bg-white p-4 rounded-md border border-blue-200 text-sm text-blue-900 leading-relaxed h-40 overflow-y-scroll mt-3 shadow-inner font-semibold">
                    {lastStatusMessage}
                </div>
            )}
        </div>
