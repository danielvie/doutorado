...
export const DashboardItem: React.FC<DashboardItemProps> = ({ id, instanceId, children, className }) => {
  ...
  return (
    <div 
      ref={ref} 
      className={`relative h-full transition-all duration-300 rounded-xl
        ${isDragging ? 'opacity-40 scale-95 grayscale' : 'opacity-100 scale-100'}
