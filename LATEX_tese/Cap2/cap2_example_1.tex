...
\highlight{$\big[2,-1\big]$} with the weight matrix \highlight{$Q = diag\big[1,1\big]$}, the maximum cycle period of \highlight{$T_{p,max} = 1s$} and minimum 
...
the cyclic trajectory around the average value \highlight{$[2, -1]$}. The corresponding command signal 
