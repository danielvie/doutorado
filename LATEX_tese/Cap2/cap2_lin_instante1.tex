...
\begin{equation}
	...
	\begin{split}
		x(t_1) - x(t_{r_1}) = \green{e^{A_0(t_1-t_0)}x(t_0) - e^{A_0(t_{r_1}-t_{r_0})}x(t_{r_0})} \\
		+ \orange{\int_{t_0}^{t_1} e^{A_0(t_1 - \tau)}B_0\partial\tau - \int_{t_{r_0}}^{t_{r_1}} e^{A_0(t_{r_1} - \tau)}B_0\partial\tau}
	\end{split}
\end{equation}
