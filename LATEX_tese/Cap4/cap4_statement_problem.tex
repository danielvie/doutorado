...
Figure \ref{cap2_linearizacao} displays the \highlight{$j$th} cycle of the switching signals \highlight{$\bar{\sigma}(t)$} and \highlight{$\sigma(t)$},
...
switching times and the resulting deviation of $x(t)$ with respect to $\hat{x}(t)$ at the end of one cycle.