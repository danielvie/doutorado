...
\comentariopurple{
    comentar o grafico da regiao de factibilidade
}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=14cm]{Cap4/fig/graf_patino_ex2_traj.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=14cm]{Cap4/fig/graf_patino_ex2_traj_2.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=14cm]{Cap4/fig/graf_patino_ex2_xi.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=14cm]{Cap4/fig/graf_patino_ex2_u_signal.pdf}
