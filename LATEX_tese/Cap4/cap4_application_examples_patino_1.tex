...
and the reference state vector for this trajectory is denoted as \highlight{$x_{ ref} = \big[2 \;\mathrm{V}, -1 \;\mathrm{A}\big]$}. 
...
They are both starting from \highlight{$x_0 = \big[2.0493 \;\mathrm{V},-0.6108 \;\mathrm{A}\big]$} and converge to the initial position of the target cyclic trajectory 
\highlight{$\bar{x}_0 = \big[1.8493 \;\mathrm{V}, -1.1108 \;\mathrm{A}\big]$}. Note that the trajectory with the MPC controller converges faster to the 
cyclic trajectory.
