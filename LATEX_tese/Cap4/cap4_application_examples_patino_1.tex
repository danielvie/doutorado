...
Figure \ref{cap4_graf_proj_patino1} presents the feasibility region $\mathcal{D}$ for three different prediction horizons 
...
\comentariopurple{
    pq a figura \ref{cap4_graf_patino1_traj} ta pulando pra prox sessao?
}
