...
\section{Contributions of the present work}
    ...
    This present work proposes an extension of the solution from \citeonline{matheus2020_artigo} to a general case
    ...
    the use of the linearized model with predictive formulation to impose the dwell time constraints.
