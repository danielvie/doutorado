...
a restricao que queremos impor é:
...
então podemos escrever a restricao da seguinte maneira
...
$\hat{\delta t}[k|k], \hat{\delta t}[k+1|k], \hat{\delta t}[k+N_p|k]$ is a sequence of manipulated vectors which are to be optimized over a prediction horizon spanning $N_p$ 
