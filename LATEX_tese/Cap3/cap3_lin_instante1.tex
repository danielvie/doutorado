...
The solution fo the state equation (\ref{eq_continuous_time_dynamics}) at time $t_N$, starting from the initial condition $x(t_0)$, is of the form
...
subtracting \ref{eq_cap2_lin_x1} and \ref{eq_cap2_lin_xr1} we get
...
and replacing (\ref{eq_cap2_lin_erro_x0x1_green}) and (\ref{eq_cap2_lin_erro_x0x1_orange}) into equation \ref{eq_cap2_lin_erro_x0x1} we get to a equation that computes $x(t_1) - x_r(t_{r_1})$ from $x(t_0) - x_r(t_{r_0})$
