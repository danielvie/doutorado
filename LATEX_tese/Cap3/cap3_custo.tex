...
deseja-se conduzir o estado $x(k)$ para a origem a partir de uma dada condicao inicial respeitando restricoes de 
estado de controle na forma 
...
$X_f$ is the maximum invariant and admissible set (MAS) with respect to the terminal state and control
