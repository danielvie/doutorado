...
The constraints are introduced aiming to drive the states of the system to the origin while solving
...
The vectors $\mathbf{\hat{x}}[k|k]$ and $\mathbf{\hat{u}}[k|k]$ are linked by
...
Combined with $\mathbf{S_u} \mathbf{u} \le \mathbf{b_u}$, it can be expressed in the form
