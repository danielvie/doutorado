...
\highlight{\highlight{$\mathcal{X}_f$}} is the maximum invariant and admissible set (MAS) concerning the terminal state and control
...
Similarly, the constraints on \highlight{$\mathbf{\hat{x}}$} can be written as
