...
replacing $\green{\square}$ and $\blue{\bigcirc}$ back in the cost equation and reordering the elements 
...
To complete the reformulation of the optimization problem in terms of $\mathbf{u}$, the constraint between $\mathbf{x}$ and $\mathbf{u}$ in the 
\textbf{restrições} must be considered
