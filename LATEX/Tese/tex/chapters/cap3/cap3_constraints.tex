...
In view of \eqref{cap3_x_in_X} and \eqref{cap3_u_in_U}, the constraints on the optimization 
...
Similarly, in light of \eqref{cap3_eq_Sx_bx}, the constraints on \highlight{$\mathbf{\hat{x}}[k]$} can be written as
