...
> Status: partially superseded by `research/reviews/introduction-reference-review-2019-2026.md`. This review describes an earlier manuscript version with a common-Lyapunov certificate. For the current conditioner and invariant raw-action certificate, use the newer review and `latex/main.tex`.
