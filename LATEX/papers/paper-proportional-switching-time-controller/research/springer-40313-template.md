...
**Checked:** 2026-08-19  
**Scope:** Official Springer/Springer Nature sources only. The official package is stored under `springer-template/`; the manuscript conversion is recorded in `latex/main.tex`.
