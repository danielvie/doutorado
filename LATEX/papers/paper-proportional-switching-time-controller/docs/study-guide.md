...
This teaching guide predates the current common-P manuscript rewrite. Its section numbering and numerical examples are not the current article specification. Use [the manuscript map](../project-knowledge/project/manuscript-description.md) for the current structure and [the Lyapunov study guide](../studies/lyapunov/README.md) for the adopted SDP and certificate. The Introduction remains author-owned and unchanged; descriptions below of what it should claim are not descriptions of its current text.

The explanations below remain background reading. Symbols should be checked against `CONTEXT.md` and `latex/main.tex` before reuse.
...
| Prior-art boundary and defensible claims | `research/reviews/novelty-review.md` |
| Reviewed literature 2021 to 2026 | `research/recent-literature-2021-2026.md` |
| Comparison against Marcolino's propagation | `research/reviews/marcolino-propagation-comparison.md` |
