...
This note reconstructs the stability argument in `latex/main.tex`, Section 3, and ties each step to a runnable MATLAB check. The plant-to-matrix derivation is worked out separately in [`deriving-a0-a1.html`](deriving-a0-a1.html). It covers three cases:
