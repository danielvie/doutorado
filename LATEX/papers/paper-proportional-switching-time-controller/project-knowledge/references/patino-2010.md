...
Source record: `latex/references.bib`; local literature PDF recorded in `research/reviews/novelty-review.md`
...
See `research/reviews/novelty-review.md`, `research/reviews/marcolino-propagation-comparison.md`, and `latex/main.tex` for the way the present manuscript describes this source. The local PDF is under the repository's `research-material/literature/` archive.
