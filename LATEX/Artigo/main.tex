...
\hline  \textbf{Hardware name} & \textit{Python-controlled three-cell converter}
...
often outsourced the design and manufacturing of the physical circuit to external companies, as documented
in the work of \cite{solano2014etude}. Our hardware aims to fill this gap by providing an easily accessible
...
\item Figura com modulação triangular.
