...
function header_text = build_header_text()
    lines = {
        ...
        // Generated by simulations/matlab-sim-sim/+z_run/+Demos/z_create_lookup.m
        ''
        '#pragma once'
        ''
...
function source_text = build_source_text(generator_config)
    ...
    lines{end+1} = '// Generated by simulations/matlab-sim-sim/+z_run/+Demos/z_create_lookup.m';
    lines{end+1} = '';
