...
Place the `.mat` file in either the `simulations/matlab-sim-sim/` root directory or directly inside the `python/` folder. Both scripts search the project directories automatically.
