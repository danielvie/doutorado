# Archived root README notes

These notes were moved out of the root `README.md` so the repository entry point can serve as a navigation index.
...
* [ok] algum material fala sobre as diferenÃ§as entre tipo de metodos `quadprog`?
...
* [ ] ComeCar a escrever um Pre-escrita
	...
	REFERENCIAS:
		...
		-> MÃ¡rcio Santos Vieira
			- [2013] :: Controle Preditivo de Sistemas com Atuadores Sujeitos a RestriÃ§Ãµes temporais de Chaveamento
			
			* Inicio da linha de estudos, preditivo calculado a cada iteracao para encontrar uma soluÃ§Ã£o atraves de uma otimizacao sujeita a restricoes temporais com MILP (Mixed Integer Linear Programming)
		...
		-> Matheus Henrique Marcolino
			...
			* Separacao do problema em 2 etapas: 
    			* uma primeira como um problema de otimizacao para calcular uma trajetÃ³ria ciclica que respeita as restricoes de tempo do sistema
...
- Notas:
	- plugin LaTeX para melhorar visualizaÃ§Ã£o MATLAB (*matlab-prettifier*):
		- https://ctan.org/pkg/matlab-prettifier?lang=en

	- criar comando LaTeX para facilitar uso de instruÃ§Ãµes (cores por exemplo) :	
		```latex
		\newcommand{\red}[1]{{\color{red}#1}}
		\red{Texto ou equaÃ§Ã£o}
		```
