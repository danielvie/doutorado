...
| `simulations/matlab-sim/` | Current MATLAB simulation/control codebase. | `simulations/matlab-sim/README.md`, `simulations/matlab-sim/DOCS/GETTING_STARTED.md` |
...
| `z_dependencies/`, `z_kawa/`, `z_mpt_install/`, `z_qpoases/` | Vendored/external dependencies and auxiliary external projects. | `z_dependencies/`, `z_qpoases/`, `z_kawa/` |
...
| `embedded/arduino/` | Arduino-based embedded work. |
| `embedded/docs-hardware/` | Datasheets, pinouts, wiring images, and hardware reference material. |
| `embedded/kicad/` | Hardware design files. |
| `embedded/scripts_matlab/`, `embedded/scripts_python/` | Embedded-support analysis and utility scripts. |
| `embedded/tests_espressif/` | Espressif test material. |
...
- Treat `z_dependencies/`, `z_kawa/`, `z_mpt_install/`, `z_qpoases/`, `simulations/backup/`, and `sandbox/` as non-canonical unless a task points there.
